...
#from load_data.data_inside.not_shared.gsr_mahnob_emotion import LoadGsrMahnobEmotion

__all__ = ["LoadGsrMahnobEmotion",]

class LoadGsrMahnobEmotion(ILoadSupervised):
    def __init__(self, data_folder="train_data/not_shared/gsr_mahnob_data"):
