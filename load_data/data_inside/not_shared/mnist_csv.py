...
class LoadMnistCsv(ILoadSupervised):
    def __init__(self, 
        trainfile='train_data/not_shared/Folder_FromKaggle/sign-language-mnist/sign_mnist_test.csv',
        testfile='train_data/not_shared/Folder_FromKaggle/sign-language-mnist/sign_mnist_train.csv'):
