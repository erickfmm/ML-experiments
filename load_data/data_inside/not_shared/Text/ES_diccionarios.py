...
class LoadDiccionario_DuenasLerin(LoadDiccionario_Abstract):
    def __init__(self, 
        filepath="train_data\\not_shared\\Folder_NLPEspañol\\diccionario-espanol-txt-master",
        letter=None):
...
class LoadDiccionario_Hunspell(LoadDiccionario_Abstract):
    def __init__(self, 
        filepath="train_data\\not_shared\\Folder_NLPEspañol\\dictionaries-master\\dictionaries",
        lang="es"):
        self.filepath = filepath
...
class LoadDiccionario_Rae_completo(LoadDiccionario_Abstract):
    def __init__(self, 
        filepath="train_data\\not_shared\\Folder_NLPEspañol\\palabras-diccionario-rae-completo-master",
        letter=None,
