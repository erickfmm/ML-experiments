...
class LoadOnuDebates(ILoadUnsupervised):
    ...
    def __init__(self, \
    path_to_csv="train_data\\not_shared\\Folder_FromKaggle\\ONU Debates de asambleas generales\\un-general-debates.csv", \
    country_codes_csv="train_data\\not_shared\\Folder_FromKaggle\\ONU Debates de asambleas generales\\ISO-Country-Codes.csv"):
