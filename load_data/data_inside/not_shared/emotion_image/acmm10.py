#train_data\not_shared\Folder_ImageEmotion\Affective Image Classification Using Features inspired by Psychology and Art Theory\testImages_artphoto
#emo_numero

#train_data\not_shared\Folder_ImageEmotion\Affective Image Classification Using Features inspired by Psychology and Art Theory\testImages_abstract
...
class LoadACMM10ImageEmotion(ILoadSupervised):
    def __init__(self, folderpath="train_data\\not_shared\\Folder_ImageEmotion\\Affective Image Classification Using Features inspired by Psychology and Art Theory"\
        , dataset="art",
