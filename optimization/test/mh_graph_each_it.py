...
#python optimization\test\mh_graph_each_it.py --mh afsa --problem Goldsteinprice --verbose 1 --seed 0
...
#from optimization.problems.nphard_real.partition__and_subset_sum import Partition_Real, Subset_Real
import optimization.problems.nonlinear_functions.two_inputs as problems_2
...
folderpath = join("train_data\\created_models\\mh_graph", args.mh+"_"+args.problem)
